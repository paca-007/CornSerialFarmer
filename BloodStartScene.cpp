...
void BloodStartScene::Enter()
{
	/// BGM
	SoundManager::GetInstance()->StopSoundBGM();
	SoundManager::GetInstance()->PlaySoundBGM(
		ResourceManager::GetInstance()->LoadResource<Sound>(L"StartBGM2", L"/Sound/BGM/ETC/Main_Title_Distorted.wav")->GetSound());
	...
	Animator* titleAnimator = new Animator(ResourceManager::GetInstance()->LoadResource<Image>(L"TitleImage2", L"/Image/Animation/title/title_2.png")->GetImage());
