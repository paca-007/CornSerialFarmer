...
PoliceTraceState::PoliceTraceState(StateMachine* onwer)
	:FSMState(onwer, "PoliceTrace")
{

}

PoliceTraceState::~PoliceTraceState()
{

}

void PoliceTraceState::Enter()
{

}

void PoliceTraceState::Update(float deltaTime)
{
	int speed = dynamic_cast<PoliceScript*>(m_Machine->m_Owner->GetComponent<MonoBehaviour>())->speed;
